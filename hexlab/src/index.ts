...
*/
function activateLab(app: JupyterFrontEnd, palette: ICommandPalette, _shell: ILabShell, restorer: ILayoutRestorer | null) {
...
* Activate the hexlab widget extension.
*/
function activateNotebook(app: JupyterFrontEnd, palette: ICommandPalette, _shell: INotebookShell, restorer: ILayoutRestorer | null) {
  console.log('[Hexlab] JupyterLab extension hexlab is activated!');
 ...
 */
const pluginLab: JupyterFrontEndPlugin<void> = {
  id: 'hexlab:pluginLab',
  autoStart: true,
  requires: [ICommandPalette, ILabShell],
  optional: [ILayoutRestorer],
  activate: activateLab,
};

const pluginNotebook: JupyterFrontEndPlugin<void> = {
  id: 'hexlab:pluginNotebook',
  autoStart: true,
  requires: [ICommandPalette, INotebookShell],
  optional: [ILayoutRestorer],
  activate: activateNotebook,
};

const plugins: JupyterFrontEndPlugin<void>[] = [pluginLab, pluginNotebook];
